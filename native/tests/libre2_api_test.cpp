...
TEST_F(Libre2APITest,R7){RE2 r("a?");EXPECT_TRUE(RE2::FullMatch("",r));EXPECT_TRUE(RE2::FullMatch("a",r));EXPECT_FALSE(RE2::FullMatch("aa",r));std::string e;RE2Pattern*p=compilePattern("a?",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,""));EXPECT_TRUE(fullMatch(p,"a"));EXPECT_FALSE(fullMatch(p,"aa"));releasePattern(p);}
TEST_F(Libre2APITest,R8){RE2 r("[a-z]+");EXPECT_TRUE(RE2::FullMatch("abc",r));EXPECT_FALSE(RE2::FullMatch("123",r));std::string e;RE2Pattern*p=compilePattern("[a-z]+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"abc"));EXPECT_FALSE(fullMatch(p,"123"));releasePattern(p);}
TEST_F(Libre2APITest,R9){RE2 r("\\w+@\\w+");EXPECT_TRUE(RE2::FullMatch("test@example",r));std::string e;RE2Pattern*p=compilePattern("\\w+@\\w+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"test@example"));releasePattern(p);}
TEST_F(Libre2APITest,R10){RE2 r("\\s+");EXPECT_TRUE(RE2::FullMatch("   ",r));std::string e;RE2Pattern*p=compilePattern("\\s+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"   "));releasePattern(p);}
TEST_F(Libre2APITest,R11){RE2 r("^foo");EXPECT_TRUE(RE2::PartialMatch("foobar",r));EXPECT_FALSE(RE2::PartialMatch("xfoo",r));std::string e;RE2Pattern*p=compilePattern("^foo",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(partialMatch(p,"foobar"));EXPECT_FALSE(partialMatch(p,"xfoo"));releasePattern(p);}
TEST_F(Libre2APITest,R12){RE2 r("bar$");EXPECT_TRUE(RE2::PartialMatch("foobar",r));EXPECT_FALSE(RE2::PartialMatch("barx",r));std::string e;RE2Pattern*p=compilePattern("bar$",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(partialMatch(p,"foobar"));EXPECT_FALSE(partialMatch(p,"barx"));releasePattern(p);}
TEST_F(Libre2APITest,R13){RE2 r("(a)(b)(c)");std::string a,b,c;EXPECT_TRUE(RE2::FullMatch("abc",r,&a,&b,&c));EXPECT_EQ("a",a);EXPECT_EQ("b",b);EXPECT_EQ("c",c);std::string e;RE2Pattern*p=compilePattern("(a)(b)(c)",true,e);ASSERT_NE(p,nullptr);std::string wa,wb,wc;const Arg a1(&wa),a2(&wb),a3(&wc);const Arg*ar[]={&a1,&a2,&a3};EXPECT_TRUE(fullMatchN(p,"abc",ar,3));EXPECT_EQ("a",wa);EXPECT_EQ("b",wb);EXPECT_EQ("c",wc);releasePattern(p);}
TEST_F(Libre2APITest,R14){RE2 r("\\d+\\.\\d+");EXPECT_TRUE(RE2::FullMatch("3.14",r));std::string e;RE2Pattern*p=compilePattern("\\d+\\.\\d+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"3.14"));releasePattern(p);}
TEST_F(Libre2APITest,R15){RE2 r("(\\d+)\\.(\\d+)");int a,b;EXPECT_TRUE(RE2::FullMatch("12.34",r,&a,&b));EXPECT_EQ(12,a);EXPECT_EQ(34,b);std::string e;RE2Pattern*p=compilePattern("(\\d+)\\.(\\d+)",true,e);ASSERT_NE(p,nullptr);int wa,wb;const Arg a1(&wa),a2(&wb);const Arg*ar[]={&a1,&a2};EXPECT_TRUE(fullMatchN(p,"12.34",ar,2));EXPECT_EQ(12,wa);EXPECT_EQ(34,wb);releasePattern(p);}

TEST_F(Libre2APITest,R16){RE2 r("a{3,5}");EXPECT_TRUE(RE2::FullMatch("aaa",r));EXPECT_TRUE(RE2::FullMatch("aaaa",r));EXPECT_TRUE(RE2::FullMatch("aaaaa",r));EXPECT_FALSE(RE2::FullMatch("aa",r));std::string e;RE2Pattern*p=compilePattern("a{3,5}",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"aaa"));EXPECT_TRUE(fullMatch(p,"aaaa"));EXPECT_TRUE(fullMatch(p,"aaaaa"));EXPECT_FALSE(fullMatch(p,"aa"));releasePattern(p);}
TEST_F(Libre2APITest,R17){RE2 r("(a+)(b+)");std::string a,b;EXPECT_TRUE(RE2::FullMatch("aaabbb",r,&a,&b));EXPECT_EQ("aaa",a);EXPECT_EQ("bbb",b);std::string e;RE2Pattern*p=compilePattern("(a+)(b+)",true,e);ASSERT_NE(p,nullptr);std::string wa,wb;const Arg a1(&wa),a2(&wb);const Arg*ar[]={&a1,&a2};EXPECT_TRUE(fullMatchN(p,"aaabbb",ar,2));EXPECT_EQ("aaa",wa);EXPECT_EQ("bbb",wb);releasePattern(p);}
TEST_F(Libre2APITest,R18){RE2 r("(a)|(b)");std::string a;EXPECT_TRUE(RE2::FullMatch("a",r,&a,nullptr));EXPECT_EQ("a",a);std::string e;RE2Pattern*p=compilePattern("(a)|(b)",true,e);ASSERT_NE(p,nullptr);std::string wa;const Arg a1(&wa),a2(nullptr);const Arg*ar[]={&a1,&a2};EXPECT_TRUE(fullMatchN(p,"a",ar,2));EXPECT_EQ("a",wa);releasePattern(p);}
TEST_F(Libre2APITest,R19){RE2 r("[[:alpha:]]+");EXPECT_TRUE(RE2::FullMatch("hello",r));std::string e;RE2Pattern*p=compilePattern("[[:alpha:]]+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"hello"));releasePattern(p);}
TEST_F(Libre2APITest,R20){RE2 r("[[:digit:]]+");EXPECT_TRUE(RE2::FullMatch("12345",r));std::string e;RE2Pattern*p=compilePattern("[[:digit:]]+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"12345"));releasePattern(p);}
TEST_F(Libre2APITest,R21){RE2 r("\\b\\w+\\b");EXPECT_TRUE(RE2::FullMatch("word",r));std::string e;RE2Pattern*p=compilePattern("\\b\\w+\\b",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"word"));releasePattern(p);}
TEST_F(Libre2APITest,R22){RE2 r("(?i)HELLO");EXPECT_TRUE(RE2::FullMatch("hello",r));std::string e;RE2Pattern*p=compilePattern("(?i)HELLO",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"hello"));releasePattern(p);}
TEST_F(Libre2APITest,R23){RE2::Options o;o.set_literal(true);RE2 r("a.b",o);EXPECT_TRUE(RE2::FullMatch("a.b",r));EXPECT_FALSE(RE2::FullMatch("axb",r));Options w;w.set_literal(true);std::string e;RE2Pattern*p=compilePattern("a.b",w,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"a.b"));EXPECT_FALSE(fullMatch(p,"axb"));releasePattern(p);}
TEST_F(Libre2APITest,R24){RE2 r("(foo|bar|baz)");std::string s;EXPECT_TRUE(RE2::FullMatch("bar",r,&s));EXPECT_EQ("bar",s);std::string e;RE2Pattern*p=compilePattern("(foo|bar|baz)",true,e);ASSERT_NE(p,nullptr);std::string w;const Arg a(&w);const Arg*ar[]={&a};EXPECT_TRUE(fullMatchN(p,"bar",ar,1));EXPECT_EQ("bar",w);releasePattern(p);}
TEST_F(Libre2APITest,R25){std::string t(1000,'a');RE2 r("a+");EXPECT_TRUE(RE2::FullMatch(t,r));std::string e;RE2Pattern*p=compilePattern("a+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,t));releasePattern(p);}
TEST_F(Libre2APITest,R26){RE2 r("(\\w+)\\s+(\\d+)");std::string s;int i;EXPECT_TRUE(RE2::FullMatch("hello 123",r,&s,&i));EXPECT_EQ("hello",s);EXPECT_EQ(123,i);std::string e;RE2Pattern*p=compilePattern("(\\w+)\\s+(\\d+)",true,e);ASSERT_NE(p,nullptr);std::string w;int wi;const Arg a1(&w),a2(&wi);const Arg*ar[]={&a1,&a2};EXPECT_TRUE(fullMatchN(p,"hello 123",ar,2));EXPECT_EQ("hello",w);EXPECT_EQ(123,wi);releasePattern(p);}
TEST_F(Libre2APITest,R27){RE2 r("a.*b");EXPECT_TRUE(RE2::PartialMatch("xaybz",r));std::string e;RE2Pattern*p=compilePattern("a.*b",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(partialMatch(p,"xaybz"));releasePattern(p);}
TEST_F(Libre2APITest,R28){RE2 r("(\\d+)([a-z]+)");int i;std::string s;EXPECT_TRUE(RE2::FullMatch("123abc",r,&i,&s));EXPECT_EQ(123,i);EXPECT_EQ("abc",s);std::string e;RE2Pattern*p=compilePattern("(\\d+)([a-z]+)",true,e);ASSERT_NE(p,nullptr);int wi;std::string ws;const Arg a1(&wi),a2(&ws);const Arg*ar[]={&a1,&a2};EXPECT_TRUE(fullMatchN(p,"123abc",ar,2));EXPECT_EQ(123,wi);EXPECT_EQ("abc",ws);releasePattern(p);}
TEST_F(Libre2APITest,R29){RE2 r("a{10}");std::string t(10,'a');EXPECT_TRUE(RE2::FullMatch(t,r));std::string e;RE2Pattern*p=compilePattern("a{10}",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,t));releasePattern(p);}
TEST_F(Libre2APITest,R30){RE2 r("\\D+");EXPECT_TRUE(RE2::FullMatch("abc",r));EXPECT_FALSE(RE2::FullMatch("123",r));std::string e;RE2Pattern*p=compilePattern("\\D+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"abc"));EXPECT_FALSE(fullMatch(p,"123"));releasePattern(p);}
TEST_F(Libre2APITest,R31){RE2 r("\\S+");EXPECT_TRUE(RE2::FullMatch("test",r));EXPECT_FALSE(RE2::FullMatch("   ",r));std::string e;RE2Pattern*p=compilePattern("\\S+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"test"));EXPECT_FALSE(fullMatch(p,"   "));releasePattern(p);}
TEST_F(Libre2APITest,R32){RE2 r("\\W+");EXPECT_TRUE(RE2::FullMatch("!!!",r));EXPECT_FALSE(RE2::FullMatch("abc",r));std::string e;RE2Pattern*p=compilePattern("\\W+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"!!!"));EXPECT_FALSE(fullMatch(p,"abc"));releasePattern(p);}
TEST_F(Libre2APITest,R33){RE2 r("(a|b)*c");EXPECT_TRUE(RE2::FullMatch("ababc",r));std::string e;RE2Pattern*p=compilePattern("(a|b)*c",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"ababc"));releasePattern(p);}
TEST_F(Libre2APITest,R34){RE2 r("[^a-z]+");EXPECT_TRUE(RE2::FullMatch("123",r));EXPECT_FALSE(RE2::FullMatch("abc",r));std::string e;RE2Pattern*p=compilePattern("[^a-z]+",true,e);ASSERT_NE(p,nullptr);EXPECT_TRUE(fullMatch(p,"123"));EXPECT_FALSE(fullMatch(p,"abc"));releasePattern(p);}
TEST_F(Libre2APITest,R35){RE2 r("(\\w)(\\d)\\2\\1");std::string s;int i;EXPECT_FALSE(RE2::FullMatch("a1",r,&s,&i));std::string e;RE2Pattern*p=compilePattern("(\\w)(\\d)\\2\\1",true,e);EXPECT_EQ(p,nullptr);}
...
TEST_F(Libre2APITest,SetTest_UnanchoredFactored){RE2::Set s1(RE2::DefaultOptions,RE2::UNANCHORED);s1.Add("foo",nullptr);s1.Add("foobar",nullptr);s1.Compile();std::vector<int>v1;EXPECT_TRUE(s1.Match("foobar",&v1));EXPECT_EQ(2u,v1.size());Set s2(Options(),RE2::UNANCHORED);s2.Add("foo",nullptr);s2.Add("foobar",nullptr);s2.Compile();std::vector<int>v2;EXPECT_TRUE(s2.Match("foobar",&v2));EXPECT_EQ(2u,v2.size());}
TEST_F(Libre2APITest,SetTest_UnanchoredDollar){RE2::Set s1(RE2::DefaultOptions,RE2::UNANCHORED);s1.Add("foo$",nullptr);s1.Compile();EXPECT_TRUE(s1.Match("foo",nullptr));EXPECT_FALSE(s1.Match("foox",nullptr));Set s2(Options(),RE2::UNANCHORED);s2.Add("foo$",nullptr);s2.Compile();EXPECT_TRUE(s2.Match("foo",nullptr));EXPECT_FALSE(s2.Match("foox",nullptr));}
TEST_F(Libre2APITest,SetTest_Prefix){RE2::Set s1(RE2::DefaultOptions,RE2::UNANCHORED);s1.Add("foo.*bar",nullptr);s1.Compile();EXPECT_TRUE(s1.Match("foobar",nullptr));EXPECT_TRUE(s1.Match("fooxbar",nullptr));Set s2(Options(),RE2::UNANCHORED);s2.Add("foo.*bar",nullptr);s2.Compile();EXPECT_TRUE(s2.Match("foobar",nullptr));EXPECT_TRUE(s2.Match("fooxbar",nullptr));}
TEST_F(Libre2APITest,SetTest_WordBoundary){RE2::Set s1(RE2::DefaultOptions,RE2::UNANCHORED);s1.Add("\\bfoo\\b",nullptr);s1.Compile();EXPECT_TRUE(s1.Match("foo",nullptr));EXPECT_FALSE(s1.Match("foobar",nullptr));Set s2(Options(),RE2::UNANCHORED);s2.Add("\\bfoo\\b",nullptr);s2.Compile();EXPECT_TRUE(s2.Match("foo",nullptr));EXPECT_FALSE(s2.Match("foobar",nullptr));}
TEST_F(Libre2APITest,PossibleMatch_Range){initCache();RE2 r("[a-z]+");std::string min1,max1;EXPECT_TRUE(r.PossibleMatchRange(&min1,&max1,5));std::string e;RE2Pattern*p=compilePattern("[a-z]+",true,e);ASSERT_NE(p,nullptr);std::string min2,max2;EXPECT_TRUE(possibleMatchRange(p,&min2,&max2,5));EXPECT_EQ(min1,min2);EXPECT_EQ(max1,max2);releasePattern(p);}
TEST_F(Libre2APITest,PossibleMatch_Literal){initCache();RE2 r("foo");std::string min1,max1;EXPECT_TRUE(r.PossibleMatchRange(&min1,&max1,10));EXPECT_EQ("foo",min1);EXPECT_EQ("foo",max1);std::string e;RE2Pattern*p=compilePattern("foo",true,e);ASSERT_NE(p,nullptr);std::string min2,max2;EXPECT_TRUE(possibleMatchRange(p,&min2,&max2,10));EXPECT_EQ("foo",min2);EXPECT_EQ("foo",max2);releasePattern(p);}
TEST_F(Libre2APITest,PossibleMatch_Class){initCache();RE2 r("[0-9]");std::string min1,max1;EXPECT_TRUE(r.PossibleMatchRange(&min1,&max1,10));EXPECT_EQ("0",min1);EXPECT_EQ("9",max1);std::string e;RE2Pattern*p=compilePattern("[0-9]",true,e);ASSERT_NE(p,nullptr);std::string min2,max2;EXPECT_TRUE(possibleMatchRange(p,&min2,&max2,10));EXPECT_EQ("0",min2);EXPECT_EQ("9",max2);releasePattern(p);}
