...
class ConfigurationTest {
    ...
    void testValidation_InvalidMaxCacheSize_Zero() {
        assertThatThrownBy(() -> new RE2Config(true, 0, 300, 60, 5, 100000, 10000))
    ...
    void testValidation_InvalidMaxCacheSize_Negative() {
        assertThatThrownBy(() -> new RE2Config(true, -1, 300, 60, 5, 100000, 10000))
            .isInstanceOf(IllegalArgumentException.class)
            .hasMessageContaining("maxCacheSize must be positive");
    }
    ...
    void testValidation_InvalidIdleTimeout_Zero() {
        assertThatThrownBy(() -> new RE2Config(true, 1000, 0, 60, 5, 100000, 10000))
            .isInstanceOf(IllegalArgumentException.class)
    ...
    void testValidation_InvalidScanInterval_Negative() {
        assertThatThrownBy(() -> new RE2Config(true, 1000, 300, -1, 5, 100000, 10000))
            .isInstanceOf(IllegalArgumentException.class)
    ...
    void testValidation_InvalidMaxSimultaneousPatterns_Zero() {
        assertThatThrownBy(() -> new RE2Config(true, 1000, 300, 60, 5, 0, 10000))
            .isInstanceOf(IllegalArgumentException.class)
    ...
    void testValidation_InvalidMaxMatchers_Zero() {
        assertThatThrownBy(() -> new RE2Config(true, 1000, 300, 60, 5, 100000, 0))
            .isInstanceOf(IllegalArgumentException.class)
    ...
    void testValidation_CacheLargerThanSimultaneousLimit() {
        assertThatThrownBy(() -> new RE2Config(true, 100000, 300, 60, 5, 50000, 10000))
            .isInstanceOf(IllegalArgumentException.class)
    ...
    void testValidation_IgnoresInvalidCacheParams_IfCacheDisabled() {
        ...
        RE2Config config = new RE2Config(false, -999, -999, -999, -999, 100000, 10000);
    ...
    void testValidation_VerySmallCache() {
        ...
        RE2Config config = new RE2Config(true, 1, 300, 60, 5, 100000, 10000);
    ...
    void testValidation_VeryLargeCache() {
        ...
        RE2Config config = new RE2Config(true, 500000, 300, 60, 5, 1000000, 10000);
